...
To locally run the development server install the dependencies (`pip install -r requirements.txt`), then run the `run.py` file. The server will start on <http://localhost:5000/>
